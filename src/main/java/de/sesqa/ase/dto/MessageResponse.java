...
/**
 * Represents a message response containing content and the role of the sender.
 * This DTO is typically used to represent a single message within a conversation.
 */
