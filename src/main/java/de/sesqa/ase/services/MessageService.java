...
public class MessageService {
     ...
     */
    private ChatMessageResponse processChatInteraction(Conversation conversation, ChatMessageRequest request) throws InterruptedException, IOException {
        sendReceivedMetrics();
    ...
    /**
     * Checks whether a conversation already exists under the ID and if so, it is loaded. If not, a new one is created.
