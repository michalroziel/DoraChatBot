...
public class Conversation {
     ...
     * This is a one-to-many relationship, where the 'conversation' field in the Message entity owns the relationship.
     * Operations on the conversation (like persist, remove) are cascaded to its messages.
     * Orphaned messages are automatically removed.
     */
     ...
     * If the message list is null, it returns an empty list.
